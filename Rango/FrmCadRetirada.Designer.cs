...
namespace Rango
{
    partial class FrmCadRetirada
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.groupBox8.Text = "Lista de Retirada";
            // 
            // DgvLista
            // 
        ...
        "ues no item, e pós fazer a alteração e clicar no alterar, ou clicar no excluir.");
            ...
            this.Text = "Cadastro Retirada";
            this.Load += new System.EventHandler(this.FrmCadRetirada_Load);
            this.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.FrmCadRetirada_KeyPress);
